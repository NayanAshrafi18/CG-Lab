...
public class LineClipping extends JPanel {
    ...
    public LineClipping(int xMin, int yMin, int xMax, int yMax, int clipperOption) {
        this.xMin = xMin;
        this.yMin = yMin;
        this.xMax = xMax;
        this.yMax = yMax;
    ...
    public static void main(String[] args) {
        ...
        String algorithms[] = {"Cohen-Sutherland"};
        ...
        mainFrame.add(new LineClipping(x0, y0, x1, y1, choice));
